...
API_ID = int(environ.get('API_ID', '25694977'))
API_HASH = environ.get('API_HASH', 'ac3500dac2df2ee746276f260fc383fa')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6199994954').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-4072065576').split()]
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-4072065576')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://aditya21057w:<2009,1,7>@cluster0.ikcklle.mongodb.net/?retryWrites=true&w=majority")
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-4054456087'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'ak_bot_disscussion')
...
URL = "https://aajkikhabarbot-a.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://aajkikhabarbot-a.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://aajkikhabarbot-a.onrender.com/".format(FQDN)
else:
    URL = "https://aajkikhabarbot-a.onrender.com/".format(FQDN)
